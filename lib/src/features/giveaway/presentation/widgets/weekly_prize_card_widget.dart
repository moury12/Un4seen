            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: CustomText(
                    "WEEK ${giveaway.weekNumber} PRIZE",
                    color: Colors.white,
                    fontSize: 14,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    SvgPicture.asset(AppIcons.reward, height: 20),
                    space8W,
                    CustomText(
                      AppStaticStrings.drawingIn.tr,
                      fontWeight: FontWeight.bold,
                      color: Colors.white,
                    ),
                  ],
                ...
                Obx(
                  () => Row(
                    ...
                    children: [
                      CountdownUnitWidget(
                        value: controller.weeklyDays.value,
                        label: AppStaticStrings.days.tr,
                      ),
                      CountdownUnitWidget(
                        value: controller.weeklyHours.value,
                        label: AppStaticStrings.hours.tr,
                      ),
                      CountdownUnitWidget(
                        value: controller.weeklyMins.value,
                        label: AppStaticStrings.mins.tr,
                      ),
                      CountdownUnitWidget(
                        value: controller.weeklySecs.value,
                        label: AppStaticStrings.secs.tr,
                      ),
                    ],
                  ),
                ),
