  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [ AppColors.kPrimaryColor.withValues(alpha: 0.8),AppColors.kPrimaryDarkColor,]),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: CustomText(week, color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold),
                ),
                space4H,
                CustomText(name, color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14),
                Row(
                  children: [
                    const Icon(Icons.card_giftcard, color: Colors.white, size: 12),
                    space4W,
                    Expanded(child: CustomText(prize, color: Colors.white, fontSize: 12)),
                  ],
                ),
              ],
            ),
